...
export const Footer = () => {
  return (
    <footer className="flex flex-col items-center gap-12 sm:gap-16 relative ">
      ...
      <div className="px-4 sm:px-8 flex flex-col items-center gap-12 sm:gap-16 w-full">
        ...
        <div className="w-full flex flex-col md:flex-row gap-10 md:gap-0 md:justify-center justify-between items-baseline">
          ...
          <div className="flex flex-col items-start gap-6 sm:gap-8 w-full md:w-1/3">
            <div className="text-xl sm:text-2xl lg:text-3xl figtree-700">
          ...
          <div className="flex flex-col items-center gap-6 sm:gap-8 w-full md:w-1/3 justify-center">
            <div className="text-xl sm:text-2xl lg:text-3xl text-black figtree-700">
              Quick Links
            </div>
            <div className="flex flex-col gap-3 sm:gap-4 montserrat-500 items-center">
              <div className="flex justify-center font-bold gap-4 sm:gap-6 text-base sm:text-lg">
                <a href="/" className="hover:text-gray-600">
                  Home
                </a>
                <a href="/pickup" className="hover:text-gray-600">
                  Pick Up
                </a>
                <a href="/catering" className="hover:text-gray-600">
                  Catering
                </a>
                <a href="/partner" className="hover:text-gray-600">
                  Partner
                </a>
              </div>
              <div className="font-bold flex justify-center gap-4 sm:gap-6 text-base sm:text-lg">
                <a href="/ourstory" className="hover:text-gray-600">
                  Our Story
                </a>
                <a href="/merch" className="hover:text-gray-600">
                  Merch
                </a>
          ...
          <div className="flex flex-col items-end gap-6 sm:gap-8 w-full md:w-1/3">
            <div className="figtree-700 text-xl sm:text-2xl lg:text-3xl text-black">
              Contact Us
            </div>
      ...
      <div className="w-full bg-black text-white py-3 sm:py-4 flex flex-col sm:flex-row justify-center sm:justify-between items-center gap-3 sm:gap-0 px-4 sm:px-48 mt-6 sm:mt-8">
